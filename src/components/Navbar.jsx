...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center h-20 max-w-[1440px] mx-auto px-4 text-white'>
        <h1 className='w-full text-3xl text-[#4169E1] m-0 leading-none animated-gradient-text' style={{ fontFamily: '"Alfa Slab One"' }}>「Christian」</h1>
        ...
        <div className={`fixed top-0 h-full w-[60%] shadow-[4px_0_15px_rgba(0,0,0,0.3)] dark:shadow-[4px_0_15px_rgba(255,255,255,0.3)]  backdrop-blur-3xl backdrop-brightness-150 transition-all duration-500 ease-in-out md:hidden ${nav ? 'left-0' : 'left-[-100%]'}`}>
