  ...
  return (
    <div className='flex justify-between items-center h-20 max-w-[1550px] mx-auto px-4 text-white sticky top-0 bg-[#FAFAFA] dark:bg-[#343434]'>
        ...
        <ul className="hidden lg:flex items-center uppercase mr-4 dark:text-[#fafafa]">
            ...
            <li className="p-4 text-md font-light cursor-pointer text-[#343434] dark:text-[#fafafa]" style={{ fontFamily: '"Poppins"' }}>Skills</li>
            <li className="p-4 text-md font-light cursor-pointer text-[#343434] dark:text-[#fafafa]" style={{ fontFamily: '"Poppins"' }}>Contacts</li>
        ...
        <div className={`fixed top-0 h-full w-[60%] shadow-[4px_0_15px_rgba(0,0,0,0.3)] dark:shadow-[4px_0_15px_rgba(255,255,255,0.3)] backdrop-blur-3xl backdrop-brightness-150 transition-all duration-500 ease-in-out lg:hidden ${nav ? 'left-0' : 'left-[-100%]'}`}>
            ...
            <ul className='uppercase p-4'>
                <li className='p-4 text-md font-light border-b border-gray-600 text-[#343434] dark:text-[#fafafa] dark:border-gray-300'><Link to="home" smooth={true} duration={600} offset={-80}>Home</Link></li>
                <li className='p-4 text-md font-light border-b border-gray-600 text-[#343434] dark:text-[#fafafa] dark:border-gray-300'><Link to="about" smooth={true} duration={600} offset={-80}>About</Link></li>
